...
void ReportAccident()
{
    ...
    System.Threading.Thread.Sleep(10000); // Wait for 10 seconds instead of 10 minutes

    Console.WriteLine("No report submitted by user within 10 seconds. Triggering automatic report...");
...
AccidentReport CollectAccidentReport()
{
    try
    {
...
void SendNotification(AccidentReport report)
{
...
void AutoReport()
{
    ...
    var autoReport = new AccidentReport
    {
        Location = "Auto-detected location",
        TimeOfAccident = "Auto-detected time",
        Description = "Auto-generated description",
        LicensePlate = "Auto-detected license plate",
        InsuranceIds = "Auto-detected insurance IDs",
        Identities = "Auto-detected identities",
        Photos = "Auto-detected photos"
    };
